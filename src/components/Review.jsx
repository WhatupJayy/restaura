...
const Review = () => {
  return (
    <section className='container mx-auto mb-8 mt-12' id='review'>
        ...
        <motion.div initial="hidden" whileInView="show" variants={itemVariants} viewport={{ once:true }} className='mt-14 flex flex-col items-center justify-center gap-2 lg:flex-row'>
